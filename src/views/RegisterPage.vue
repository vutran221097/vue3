            ...
            <div class="w-full bg-main rounded-lg shadow md:mt-0 sm:max-w-xl xl:p-0 ">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <Form class="space-y-4" @submit="onSubmit" :validation-schema="signUpSchema">
                        ...
                        <button type="submit"
                            class="w-full bg-secondary text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create
                            an account</button>
